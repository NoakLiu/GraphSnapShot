...
from div_graph_by_deg_homo import load_and_split_dataset
...
if __name__ == "__main__":
    ...
    mem_before_g = psutil.virtual_memory().used
    g = dataset[0]

    # gg, g, _ = load_and_split_dataset('ogbn-arxiv', 30) # products
    ...
    print("mem for G used:",(mem_after_g-mem_before_g)/(1024**2))
