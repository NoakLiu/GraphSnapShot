...
from dgl.dataloading import DataLoader, MultiLayerNeighborSampler, NeighborSampler_FBL, NeighborSampler_FCR_struct, NeighborSampler_OTF_struct
...
def train(device, g, target_idx, labels, train_mask, num_classes, model):
    ...
    sampler = MultiLayerNeighborSampler([20, 20])
