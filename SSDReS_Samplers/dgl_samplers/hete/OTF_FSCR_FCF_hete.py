...
class NeighborSampler_OTF_struct_FSCRFCF(BlockSampler):
    ...
    def refresh_cache(self,g, layer_id, cached_graph_structure, fanout_cache_refresh):
        """
    ...
    def sample_blocks(self, g, seed_nodes, exclude_eids=None):
        ...
        if((self.cycle % self.T)==0):
            for i in range(0,len(self.cached_graph_structures)):
                ...
                self.cached_graph_structures[i]=self.refresh_cache(g, i, self.cached_graph_structure[i], fanout_cache_refresh)
