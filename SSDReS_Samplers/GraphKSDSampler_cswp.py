...
class GraphKSDSampler:
    ...
    def resample(self, n, alpha, n_per_hop=3):
        ...
        cutoff_dynamic_resampled_nodes = random.sample(static_resampled_nodes, int(0.1 * n))

        dynamic_resampled_nodes_swap_in = random.sample(non_static_nodes, int(0.1 * n))
        self.k_hop_resampling(
            dynamic_resampled_nodes_swap_in)  # proportional to constant*nph from disk to memory
