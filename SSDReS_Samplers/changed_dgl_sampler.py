...
class SSRDeSSampler(NeighborSampler):
    def __init__(self, fanouts, edge_dir="in", prob=None, mask=None, replace=False, prefetch_node_feats=None, prefetch_labels=None, prefetch_edge_feats=None, output_device=None, fused=True):
        super().__init__(fanouts, edge_dir, prob, mask, replace, prefetch_node_feats, prefetch_labels, prefetch_edge_feats, output_device, fused)

    def SSDReS():
        return static_sampler, dynamic_resampler

class ClockwiseSampler(NeighborSampler):
    def __init__(self, fanouts, edge_dir="in", prob=None, mask=None, replace=False, prefetch_node_feats=None, prefetch_labels=None, prefetch_edge_feats=None, output_device=None, fused=True):
        super().__init__(fanouts, edge_dir, prob, mask, replace, prefetch_node_feats, prefetch_labels, prefetch_edge_feats, output_device, fused)

    def asyn_clock():
        return list(clocks_sampler)
