...
from models import GAT, MWE_GCN
...
def run(
    ...
    train_sampler = NeighborSampler_OTF_struct(
        g=graph,
        fanouts=[32 for _ in range(args.n_layers)],  # fanout for [layer-0, layer-1, layer-2] [2,2,2]
    ...
    eval_sampler = MultiLayerFullNeighborSampler(
        g=graph,
